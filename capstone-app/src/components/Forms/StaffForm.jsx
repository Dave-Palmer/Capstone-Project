...
export default function StaffFormDialog(props) {
    ...
    const handleSubmitNew = (e) => {
        ...
        axios.post('http://localhost:8009/users/create', newUser, { headers: { 'x-access-token': props.currentUser.token } })
    ...
    const handleSubmitUpdate = (e) => {
        ...
        axios.put('http://localhost:8009/users/' + userId, updatedUser, { headers: { 'x-access-token': props.currentUser.token } })
            .then(response => { handleRespone(response) })
