...
export default function ReportFromDialog(props) {
    ...
    const handleSubmitUpdate = (e) => {
        ...
        axios.put(`http://localhost:8009/${props.collection}/${id}`, { alertDescription: editedAlertDescription, alert: true })
    ...
    const handleClear = () => {
        let type = 'clear'
        axios.put(`http://localhost:8009/${props.collection}/${id}`, { alertDescription: '', alert: false })
            .then(response => { handleRespone(response, type) })
            .catch(e => { handleRespone(e.message) })
    }
