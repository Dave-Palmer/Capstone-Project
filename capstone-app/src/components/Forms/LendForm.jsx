...
export default function LendFormDialog(props) {
    ...
    useEffect(() => {
        axios('http://localhost:8009/users/usernames', { headers: { 'x-access-token': currentUser.token } })
    ...
    const handleSubmit = (e) => {
        e.preventDefault()
        axios.put(`http://localhost:8009/items/${id}`, { lentTo: staffRecipient, lent: true })
